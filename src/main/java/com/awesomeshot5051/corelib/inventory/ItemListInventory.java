...
public class ItemListInventory implements Container {
    ...
    private java.util.function.Function<Player, Boolean> onIsUsableByPlayer;

    public ItemListInventory(NonNullList<ItemStack> items, Runnable onMarkDirty, java.util.function.Function<Player, Boolean> onIsUsableByPlayer) {
        this.items = items;
