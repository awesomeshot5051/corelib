...
public class ContainerFactoryTileEntity<T extends AbstractContainerMenu, U extends BlockEntity> implements IContainerFactory<T> {
    ...
    private final com.awesomeshot5051.corelib.inventory.ContainerFactoryTileEntity.ContainerCreator<T, U> containerCreator;

    public ContainerFactoryTileEntity(com.awesomeshot5051.corelib.inventory.ContainerFactoryTileEntity.ContainerCreator<T, U> containerCreator) {
