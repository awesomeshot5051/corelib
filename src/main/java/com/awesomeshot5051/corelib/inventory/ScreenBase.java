...
public class ScreenBase<T extends AbstractContainerMenu> extends AbstractContainerScreen<T> {
    ...
    protected java.util.List<com.awesomeshot5051.corelib.inventory.ScreenBase.HoverArea> hoverAreas;

    public ScreenBase(ResourceLocation texture, T container, Inventory playerInventory, Component title) {
        super(container, playerInventory, title);
        this.texture = texture;
        this.hoverAreas = new java.util.ArrayList<>();
    }
    ...
    public void drawHoverAreas(GuiGraphics guiGraphics, int mouseX, int mouseY) {
        for (com.awesomeshot5051.corelib.inventory.ScreenBase.HoverArea hoverArea : hoverAreas) {
    ...
    public static class HoverArea {
        ...
        private final java.util.function.Supplier<java.util.List<FormattedCharSequence>> tooltip;

        public HoverArea(int posX, int posY, int width, int height) {
            this(posX, posY, width, height, null);
        }

        public HoverArea(int posX, int posY, int width, int height, java.util.function.Supplier<java.util.List<FormattedCharSequence>> tooltip) {
            this.posX = posX;
            this.posY = posY;
            this.width = width;
            this.height = height;
        ...
        @javax.annotation.Nullable
        public java.util.function.Supplier<java.util.List<FormattedCharSequence>> getTooltip() {
            return tooltip;
        }
